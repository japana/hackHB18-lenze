...
public class MessageParser {
    ...
    static {
        errorMap.put(778, "Die Temperatur ist zu hoch.");
        errorMap.put(779, "Die Temperatur ist zu niedrig.");
    }

    static {
        hintMap.put(778, "Bitte prüfen Sie ob alle die Thermometer zu nah an den Heizöfen stehen");
        hintMap.put(779, "Bitte stellen Sie sicher, das alle Türen zum Außenbereich geschlossen sind.");
    }
